...
export default function NewProjectEditorPage() {
  ...
  const handleSaveProject = async () => {
    ...
    try {
      ...
      // After saving, redirect to the actual project page with the new ID
      if (project?.id) {
    ...
    return (
      <div className="h-screen flex items-center justify-center bg-secondary-50">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-secondary-700">Setting up your new project...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="h-screen flex items-center justify-center bg-secondary-50">
        <div className="max-w-md p-8 bg-white rounded-lg shadow-md text-center">
          ...
          <h2 className="text-2xl font-bold text-secondary-900 mt-4">Failed to create project</h2>
