...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const navigation = [
    ...
    { name: 'Images', href: '/dashboard/images', icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Mobile sidebar */}
      <div className={`fixed inset-0 flex z-40 md:hidden ${isSidebarOpen ? '' : 'invisible'}`}>
        {/* Overlay */}
        <div
          className={`fixed inset-0 bg-secondary-600 bg-opacity-75 transition-opacity ease-in-out duration-300 ${
        ...
        {/* Sidebar */}
        <div className={`relative flex-1 flex flex-col max-w-xs w-full bg-secondary-800 transform ease-in-out duration-300 ${
          ...
          <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            <div className="flex-shrink-0 flex items-center px-4">
              <Link href="/" className="flex items-center space-x-2">
                ...
                <span className="text-lg font-bold text-white">Landing Pad</span>
              </Link>
            </div>
          ...
          <div className="flex-shrink-0 flex border-t border-secondary-700 p-4">
            <div className="flex-shrink-0 group block">
              <div className="flex items-center">
                <div className="inline-block h-9 w-9 rounded-full bg-secondary-700 text-secondary-300 text-center leading-9">
                  {user.name.charAt(0)}
                </div>
                <div className="ml-3">
