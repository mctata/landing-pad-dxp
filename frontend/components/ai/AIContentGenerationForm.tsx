...
export default function AIContentGenerationForm({
    ...
    switch (elementType) {
      ...
      case 'text':
        return [
          ...
          'Create a product description for a wireless headphone',
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4" aria-label="AI content generation form">
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          {getSamplePrompts().map((samplePrompt, index) => (
            <button
              ...
              aria-label={`Use prompt: ${samplePrompt.length > 40 ? samplePrompt.substring(0, 40) + '...' : samplePrompt}`}
